...
SELECT 
    ...
    W.[GW3_DTBLQ],
    W.[GW3_USUBLQ],
    CONVERT(VARCHAR(10), CAST(W.[GW3_DTAPR] AS DATE), 103) AS DtAprovacaoFatura,

    W.[GW3_USUAPR],
    W.[GW3_EMIFAT],
    W.[GW3_SERFAT],
    W.[GW3_NRFAT],
   	CONVERT(VARCHAR(10), CAST(W.[GW3_DTEMFA] AS DATE), 103) AS DtEmissaoFatura,
    W.[GW3_VLDIV],
    CASE 
...
when w.GW3_TPDF = 6 then 'Redespacho'
    ...
    CONVERT(VARCHAR(10), CAST(G6.GW6_DTVENC AS DATE), 103) AS DtVencimento,
    G6.GW6_VLFATU,
    G6.GW6_SITFIN,
