...
SELECT
    GW6.GW6_EMIFAT AS TranspFatura,
    ...
    GW3.GW3_USUIMP AS UsuarioImportacaoGW3,
    ...
    GW3.GW3_EMIFAT AS EmissorFaturaCTE,
    GW3.GW3_SERFAT AS SerieFaturaCTE,
    GW3.GW3_NRFAT AS NumFaturaCTE,
    CAST(GW3.GW3_DTEMFA AS DATE) AS DataEmissaoFaturaCTE,
    GW3.GW3_VLDIV AS ValorDivergente,
    GW3.GW3_SITDIV AS SitDivergencia,

    GWM.GWM_SERDOC AS SerieCTE_GWM,
    GWM.GWM_NRDOC AS NumeroCTE_GWM,
    CAST(GWM.GWM_DTEMIS AS DATE) AS DataEmissaoGWM,
